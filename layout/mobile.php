<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-right">
        <a class="navbar-brand brand-logo" href="index.php">
          <h3 class="page-title"><strong>STDC Asset</strong></h3>
        </a>
        <a class="navbar-brand brand-logo-mini" href="index.php">
           <h5 class="page-title"><strong>STDC Asset</strong></h5>
        </a>
      </div>
