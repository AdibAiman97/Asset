...
<?php
    ...
    <div class="header-container">
        ...
        <h1 class="display-10 font-weight-bold">DISPOSAL RECORD INFORMATION</h1>
    </div>
<br>
<br>
...
<div class="section-header">DISPOSAL</div>
    <table class="table no-border-table">
        
        <tr>
            <th>Date:</th>
            <td><?php echo date('d/m/Y', strtotime($row['disposal_date'])); ?></td>
        </tr>
        <tr>
            <th>Officer Name:</th>
