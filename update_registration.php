        ...
        <div class="content-wrapper">
          <div class="row">
					...
					if (isset($_POST['submit'])) {
						...
						if ($update) {
							echo "<div class='alert alert-success alert-dismissible'>
									...
									<strong>Success!</strong> Asset Registration updated successfully.
								  </div>";
						} else {
							echo "<div class='alert alert-danger alert-dismissible'>
									<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
									<strong>Error!</strong> Failed to update registration.
								  </div>";
						}
					}
				}
			...
			?>
              <div class="card">
                <div class="card-body">
                  <h1 class="display-5 font-weight-bold"><i class='menu-icon hgi-stroke hgi-image-add-02'></i> Update Registration of Asset</h1>
                  <form method="post" enctype="multipart/form-data">
					...
					<a href="registration_list.php" class="btn btn-outline-dark">
